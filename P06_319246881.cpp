...
// average normals
	GLfloat cubo_vertices[] = {
		// front
		-0.5f, -0.5f,  0.5f,	0.24f,  0.35f,		0.0f,	0.0f,	-1.0f,
		 0.5f, -0.5f,  0.5f,	0.02f, 0.35f,		0.0f,	0.0f,	-1.0f,
		 0.5f,  0.5f,  0.5f,	0.02f, 0.64f,		0.0f,	0.0f,	-1.0f,
		...
		// right
		 ...
		 0.5f,  0.5f, -0.5f,	0.49f,  0.64f,		-1.0f,	0.0f,	0.0f,
		 0.5f,  0.5f,  0.5f,	0.26f,  0.64f,		-1.0f,	0.0f,	0.0f,

		 // back
		 -0.5f, -0.5f, -0.5f,	0.51f,  0.35f,		0.0f,	0.0f,	1.0f,
		  0.5f, -0.5f, -0.5f,	0.74f,  0.35f,		0.0f,	0.0f,	1.0f,
		  0.5f,  0.5f, -0.5f,	0.74f,  0.64f,		0.0f,	0.0f,	1.0f,
		 -0.5f,  0.5f, -0.5f,	0.51f,  0.64f,		0.0f,	0.0f,	1.0f,

		 // left
		 -0.5f, -0.5f, -0.5f,	0.76f,  0.35f,		1.0f,	0.0f,	0.0f,
		 -0.5f, -0.5f,  0.5f,	0.99f,  0.35f,		1.0f,	0.0f,	0.0f,
		 -0.5f,  0.5f,  0.5f,	0.99f,  0.64f,		1.0f,	0.0f,	0.0f,
		 -0.5f,  0.5f, -0.5f,	0.76f,  0.64f,		1.0f,	0.0f,	0.0f,

		 // bottom
		 -0.5f, -0.5f,  0.5f,	0.51f,  0.98f,		0.0f,	1.0f,	0.0f,
		  0.5f, -0.5f,  0.5f,	0.73f,  0.98f,		0.0f,	1.0f,	0.0f,
		  0.5f, -0.5f, -0.5f,	0.73f,  0.67f,		0.0f,	1.0f,	0.0f,
		 -0.5f, -0.5f, -0.5f,	0.51f,  0.67f,		0.0f,	1.0f,	0.0f,

		 // up
		 -0.5f,  0.5f,  0.5f,	0.50f, 0.02f,		0.0f,	-1.0f,	0.0f,
		  0.5f,  0.5f,  0.5f,	0.74f, 0.02f,		0.0f,	-1.0f,	0.0f,
		  0.5f,  0.5f, -0.5f,	0.74f,  0.31f,		0.0f,	-1.0f,	0.0f,
		 -0.5f,  0.5f, -0.5f,	0.50f,  0.31f,		0.0f,	-1.0f,	0.0f,
	};
...
int main()
{
	...
	dado8_M = Model();
	dado8_M.LoadModel("Models/dado8.dae");
	capo_M = Model();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Capo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.0f, 3.1f, 0.8f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//espejo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.0f, -0.35f, -3.2f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		espejoTexture.UseTexture();
		espejo_M.RenderModel();

		//Llanta delantera izquierda
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.8f, 1.0f, 5.4f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.8f, 1.2f, -5.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		LLANTASTexture.UseTexture();
