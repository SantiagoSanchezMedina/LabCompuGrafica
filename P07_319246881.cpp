...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		spotLights[2].SetFlash(glm::vec3(1.0f - mainWindow.getmuevez(), 3.0f, 6.3f), glm::vec3(0.0f, -1.0f, 0.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 5.9f, 1.0));
		...
		//Helicoptero
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(mainWindow.getmuevex(), 5.0f, 6.0f) + mainWindow.getmuevez() * glm::vec3(-1.0f, 0.0f, 0.0f));
